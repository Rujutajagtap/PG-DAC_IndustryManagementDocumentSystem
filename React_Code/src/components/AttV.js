        ...
        <ul className="nav justify-content-end">
            ...
            <li className="nav-link text-info">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <Link className="nav-link text-info" to=""><a class="dropdown-item" >Add attendance</a></Link>
                        <Link className="nav-link text-info" to=""><a class="dropdown-item" >View attendance</a></Link>
                    </div>
                </div>
            </li>
            ...
            <li className="nav-link text-info">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <Link className="nav-link text-info" to="/AttV"><a class="dropdown-item" >Attendance</a></Link>
                        <Link className="nav-link text-info" to="/MachineList"><a class="dropdown-item" >Machine List</a></Link>
                    </div>
                </div>
            </li>
