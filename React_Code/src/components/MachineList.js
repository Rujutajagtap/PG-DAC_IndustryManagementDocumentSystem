            ...
            <li className="nav-link text-info">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <Link className="nav-link text-info" to="addBreakdown"><a class="dropdown-item" >Add AddBreakDown</a></Link>
                        <Link className="nav-link text-info" to="breakDown"><a class="dropdown-item" >View BreakDown</a></Link>
                    </div>
                </div>
            </li>
            ...
            <li className="nav-link text-info">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <Link className="nav-link text-info" to="/addAttendance"><a class="dropdown-item" >Add Attendance</a></Link>
            ...
            <li className="nav-link text-info">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <Link className="nav-link text-info" to="/Audit"><a class="dropdown-item" >Maintainance</a></Link>
                        </div>
                    </div>
            </li>
